...
This repository aims to maintain up-to-date instructions for setting up a Plinth development environment. There are three possibilities how to setup the environment:  
...
* [Using Demeter.run](https://github.com/iohkedu/plutus-dev-env/blob/main/instructions/using-demeter-run.md) online platform that provides up-to-date development environments for Plinth and other Cardano SC languages. 
...
The [plutus-tx-template](https://github.com/IntersectMBO/plutus-tx-template/tree/main) repository also contains a Docker image and it contains a Nix shell that both provide a Plinth development environment, 
